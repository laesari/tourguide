            ...
            <div class="w3-third">
      			<div class="w3-white w3-text-grey w3-card-4">
        			<div class="w3-display-container">
          				<img src="pictures/jomblang_cave.png" style="width:100%" alt="Avatar"/></img>
        			</div>
        			<div class="w3-container">
						<hr>
						<br>
						<div class="w3-light-grey w3-round-xlarge">
							<img src="pictures/destination/jomblang_cave.png" style="width:100%" style="height:197px"/></img>
						</div>
						<br>
					</div>
				</div>
				...
				<div class="w3-container w3-card w3-white w3-margin-bottom">
						...
						<form action="booking.php" method="get">
							...
							<div class="w3-container">
								<h6 class="w3-text-teal"><img src="pictures/location.jfif" height="20px" width="20px"/>
									&nbsp &nbsp
									<input value="Jomblang Cave" name="paket" size="19"></input>
								</h6>
							...
							<div class="w3-container">
								...
								<h6 class="w3-text-teal"><img src="pictures/rupiah.png" height="20px" width="20px"/>&nbsp &nbsp &nbsp
									<input type="text" placeholder="Total" id="total" name="total" value="830000" size="19" />
								</h6>
								<hr>
							</div>
							<div class="w3-container">
					...
					<div class="w3-container">
						<div class="w3-content" style="max-width:800px">
							<img class="mySlides" src="fix/jom cave 1.png" style="width:100%">
							<img class="mySlides" src="fix/jom cave 2.png" style="width:100%">
							<img class="mySlides" src="fix/jom cave 3.png"style="width:100%">
						</div>
						<div class="w3-center">
