          		...
          		<div class="container">
            		<div class="content-center">
						...
						<div id="id02" class="modal">
  							<form class="modal-content animate" action="prosesDaftarUser.php" method="post">
                                <div class="imgcontainer">
                                    <span onclick="document.getElementById('id02').style.display='none'" class="close" title="Close Modal">&times;</span>
                                    <img src="pictures/avatar2.png" alt="Avatar" class="avatar">
                                </div>
    
                                <div class="container">
                                    <input type="text" placeholder="Enter Username" name="uname" maxlength="12" />
									<label for="telp" maxlength="12"><b>Who Are You?</b></label><br>
									<input type="radio" name="jenis" value="tr"> Traveler
									<input type="radio" name="jenis" value="tg"> Tour Guide<br>
                                    <input type="text" placeholder="Enter Telp" name="tlp" maxlength="12"/>
                                    <input type="password" placeholder="Enter Password" name="psw" maxlength="8"/>
						...
						<div id="id01" class="modal">
  							<form class="modal-content animate" action="prosesLogin.php" method="post">
                                ...
                                <div class="container">
                                    <input type="text" placeholder="Enter Username" name="username" maxlength="12"/>
